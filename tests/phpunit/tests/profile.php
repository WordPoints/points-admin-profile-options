 ...
 * @since 1.0.0
 *
 * @covers ::wordpoints_points_admin_profile_options_update
 */
class WordPoints_Points_Admin_Profile_Options_Update_Test
	...
	public function test_points_can_be_0() {
		...
		wordpoints_points_admin_profile_options_update( $this->user->ID );
